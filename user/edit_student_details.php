            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php">LiteraTech Hub</a>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="user.php"><i class="menu-icon icon-home"></i>Home
                                </a></li>
                                    ...
                                    <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name = "Category" tabindex="1" value="SC" data-placeholder="Select Category" class="span6">
                                                    ...
                                                    <option value="OBC">TECHER</option>
                                                    <option value="SC">EMPLOYEE</option>
